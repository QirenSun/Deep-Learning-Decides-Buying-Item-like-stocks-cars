# -*- coding: utf-8 -*-
"""
Created on Sun Mar 17 17:07:19 2019
...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar  1 19:58:14 2019
...
X_train,X_test,Y_train,Y_test=train_test_split(z,Y,test_size=0.2,shuffle=False)
...
def manh(x):
    ...
    for k in range(len(X_test)):
        ...
        if num1>num2:
            ...
            knn1.append(0)
    error_rate=np.sum(knn1==Y_test)/len(Y_test)
