...
def manh(x):
    ...
    correct=np.sum(y_t==Y_test)/len(Y_test)
    return correct
...
def test_ma():
    ...
    n_neighbors=2*num+1
    correct=manh(n_neighbors)
    return correct,n_neighbors

def test_eu():
    num=error_rate.index(min(error_rate))
    n_neighbors=2*num+1
    correct=euclidean(n_neighbors)
    return correct,n_neighbors

def test_mi():
    num=error_rate.index(min(error_rate))
    n_neighbors=2*num+1
    correct=minkowski(n_neighbors)
    return correct,n_neighbors
...
for i in range(1,31,2):
    manh(i)
ma_correct,k=test_ma()
print('KNN-manhattan accuracy:'+str(round(ma_correct,4)))
print('k: '+ str(k)+'\n')
#plot()
...
for i in range(1,31,2):
    euclidean(i)
eu_correct,k=test_eu()
print('KNN-Euclidean accuracy:'+str(round(eu_correct,4)))
print('k: '+ str(k)+'\n')    
#plot()
...
for i in range(1,31,2):
    minkowski(i)
mi_correct,k=test_mi()
print('KNN-Minkowski accuracy:'+str(round(mi_correct,4)))
print('k: '+ str(k)+'\n') 
#plot()
...
print('NB Correct', np.mean(prediction==Y_test))
